    ...
    return (
        <div className="container py-4">
            ...
            <div className="input-group mb-3">
                ...
                <input type="text" className="form-control" placeholder="people/1/" aria-label="SWAPI endpoint" />
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <pre className="bg-light p-3 rounded text-break text-dark small">{JSON.stringify(mockData, null, 2)}</pre>
                </div>
            </div>
        </div>
    );
